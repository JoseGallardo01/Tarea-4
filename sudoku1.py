...
'''Se define la función que muestra el resultado en la consola de python'''
def resultado(a):
    for i in range(M):
        for j in range(M):
            print(a[i][j],end = " ")
...
'''Se llama la función Sudoku con la matríz con pistas otorgadas en el argumento e inicio 0,0'''
if (suduko(tabla, 0, 0)):
    resultado(tabla)
else:
    print("No existe solución para las pistas dadas")
